...
//
// Copied verbatim from vsreact/js/src/tools/FilmStripKnob.tsx, with the import
// retargeted to the public package. The strip is produced by bakeKnobStrip.ts.

import { View, Image } from "@vsreact/core";
...
/** The frame index that best represents `rotation`. */
